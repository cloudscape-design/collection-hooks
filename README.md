...
The [contribution guidelines](https://github.com/cloudscape-design/collection-hooks/blob/main/CONTRIBUTING.md) contains information on how to contribute, as well as our support model and versioning strategy.
